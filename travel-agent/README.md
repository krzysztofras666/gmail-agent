...
This is a **separate project** from [gmail-agent](https://github.com/krzysztofras666/gmail-agent). It can share the same `OPENAI_API_KEY` and Gmail OAuth tokens for the daily email digest.

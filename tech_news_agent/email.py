...
from tech_news_agent.models import RunResult
from tech_news_agent.render_html import build_subject, render_html, render_plain_text
...
def send_digest(
    ...
    *,
    ...
    if out_path is None:
        out_path = Path("logs/last_tech_news_email.html")
